//
//  SLPubSearchResultVC.swift
//  SLAPP
//
//  Created by 董建伟 on 2019/1/23.
//  Copyright © 2019 柴进. All rights reserved.
//

import UIKit

class SLPubSearchResultVC: BaseVC,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if cell == nil {
            cell = SLPublicCluesPoolCell.init(style: UITableViewCellStyle.default, reuseIdentifier: indentifier)
        }
        let cluesCell = cell as! SLPublicCluesPoolCell
        
        let model:SLPublicModel = self.searchDataArr[indexPath.row]
