...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
    if (self.activeLink) {
        ...
        //自己添加的
        if (self.delegate && [self.delegate respondsToSelector:@selector(didClickOtherLink:linkText:linkLabel:)]) {
            [self.delegate didClickOtherLink:nil linkText:@"" linkLabel:self];
        }
