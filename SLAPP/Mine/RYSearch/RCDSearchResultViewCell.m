...
- (void)setDataModel:(RCDSearchResultModel *)model {
    ...
    if (model.conversationType == ConversationType_PRIVATE)
    {
      //单聊
        ...
        if (tModel != nil) {
            [self.headerView
             sd_setImageWithURL:[NSURL URLWithString:tModel.avater]
             placeholderImage:[UIImage imageNamed:@"mine_avatar"]];
        }
        else{
            self.headerView.image = [UIImage imageNamed:@"mine_avatar"];
        }
    ...
    }else if (model.conversationType == ConversationType_GROUP)
    {
      //多聊
        ...
        if (model != nil) {
            [self.headerView
                         sd_setImageWithURL:[NSURL URLWithString:myModel.icon_url]
                           placeholderImage:[UIImage imageNamed:@"mine_avatar"]];
        }
